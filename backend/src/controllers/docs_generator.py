...
def generate_assignment_docx(json_data_str: str, output_path: str = "Assignment.docx", logo_path: str = None):
    ...
    questions = assignment_info.get("questions", [])
    ...
    run_title = p_title.add_run(f"Assignment # 0{assignment_info.get('assignment_no', 1)}")
    ...
    details = [
        ("Student Name:", str(assignment_info.get("student_name", ""))),
        ("Registration ID:", str(assignment_info.get("registration_id", ""))),
        ("Course Code:", str(assignment_info.get("course_code", ""))),
        ("Course Title:", str(assignment_info.get("course_title", "")))
    ]
    ...
    for q_idx, q in enumerate(questions, start=1):
        ...
        for sec in q.get("sections", []):
            ...
            run_body = p_body.add_run(sec.get("detailed_explanation", ""))
